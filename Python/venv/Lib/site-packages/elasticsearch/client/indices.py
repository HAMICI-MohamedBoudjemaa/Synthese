...
class IndicesClient(NamespacedClient):
    ...
    @query_params("main_timeout", "request_timeout")
    ...
    @query_params("main_timeout", "request_timeout", "timeout")
    ...
    @query_params("flat_settings", "local", "main_timeout", "include_type_name")
    ...
    @query_params(
        "main_timeout", "timeout", "request_timeout", "wait_for_active_shards"
    )
    ...
    @query_params("main_timeout", "timeout", "wait_for_active_shards")
